...
const FoodItem = () => {
    return (
        <div>
            <h2 className='text-center text-5xl font-bold text-orange-500 mt-10'>Our favorite food dishes</h2>
            <div className='grid md:grid-cols-3 p-10 gap-10'>
                ...
                <div className='rounded shadow-md'>
                    ...
                    <div className='p-5'>
                        <h2 className='text-3xl mb-2'>Seafood </h2>
                ...
                <div className='rounded shadow-md'>
                    ...
                    <div className='p-5'>
                        <h2 className='text-3xl mb-2'>Pasta</h2>
                ...
                <div className='rounded shadow-md'>
                    ...
                    <div className='p-5'>
                        <h2 className='text-3xl mb-2'>Tiramisu</h2>
                ...
                <div className='rounded shadow-md'>
                    ...
                    <div className='p-5'>
                        <h2 className='text-3xl mb-2'>Bruschetta</h2>
