                ...
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            <Link to='/'><li className='mr-5 font-bold text-2xl  hover:text-orange-500'>Home</li></Link>
                            <Link to='/blog'><li className='mr-5 font-bold text-2xl hover:text-orange-500'>Blog</li></Link>
                        </ul>
                    </div>
