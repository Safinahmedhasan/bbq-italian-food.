                ...
                <div className="card-body">
                    ...
                    <div className="card-actions">
                            ...
                            <div class="cursor-pointer mt-5">
                                <span class="flex h-10 w-20 space-x-1 items-center pl-5 rounded-full text-gray-400 hover:text-rose-600 bg-gray-700 hover:bg-orange-200 py-1 px-2 text-xs font-medium">
